const backgroundDataMap = {
  ...
  draevi: {
    horn_carved_wanderer: {
      trained_skills: ["veil_lore", "occult", "survival", "first_aid", "insight", "track", "arcana"],
    ...
    tradition_keeper: {
      trained_skills: ["survival", "navigate", "perception", "athletics", "occult", "track", "first_aid"],
    ...
    forgeblood_scavenger: {
      trained_skills: ["mechanics", "electronics", "insight", "streetwise", "coordination", "perception", "survival"],
  ...
  human: {
    scavsteel_whelp: {
      trained_skills: ["mechanics", "electronics", "streetwise", "insight", "slicing", "survival", "perception"],
    ...
    outpost_raised: {
      trained_skills: ["survival", "firearms_rifle", "mechanics", "navigate", "first_aid", "insight", "drive"],
